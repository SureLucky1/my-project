...
export const plans = [
  {
    id: 1,
    desc: "1 song reviewed + YouTube Upload",
    price: "$165",
    planDesc: "I will create a High-Quality Video Review of One Song for you to use for Promotion + YouTube Upload",
    Days: "4 Days Delivery",
    time: 7,
  },
  {
    id: 2,
    desc: "2-3 songs reviewed + YouTube Upload",
    price: "$330",
    planDesc: "I will create a High-Quality Video Review of 2-3 Songs for you to use for Promotion + YouTube Upload",
    Days: "5 Days Delivery",
    time: 21,
  },
  {
    id: 3,
    desc: "4-6 songs reviewed + YouTube Upload",
    price: "$495",
    planDesc: "I will create a High-Quality Video Review of 4-6 Songs for you to use for Promotion + YouTube Upload",
    Days: "6 Days Delivery",
    time: 42,
  },
];
